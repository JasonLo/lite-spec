...
3. **Surface impact**. Scan the repo for files that may be affected:
   ...
   - Produce a short impact list: which intents (by ID) and code paths would be affected.
